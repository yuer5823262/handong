...
public class DecodeRequestBodyAdvice implements RequestBodyAdvice {
    ...
    class MyHttpInputMessage implements HttpInputMessage {
        ...
        public MyHttpInputMessage(HttpInputMessage inputMessage) throws Exception {
            ...
            JSONObject jsonObject = JSONObject.parseObject(IOUtils.toString(inputMessage.getBody(), StandardCharsets.UTF_8));
            String result = jsonObject.getString("requestData");
            this.body = IOUtils.toInputStream(AesUtil.decrypt(result), "UTF-8");
        }
