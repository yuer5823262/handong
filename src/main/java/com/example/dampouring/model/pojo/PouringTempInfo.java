...
public class PouringTempInfo {
    ...
    public String toMqStr(PouringBaseVO pouringBase,Double avgTemp) {
        String iscb="否";
        if(temperature>=norm)
            iscb="是";
        return "浇筑温度"+","+pouringBase.getSmallSbNo()+","+time+","+temperature+","+norm+
                ","+iscb+","+pouringBase.getMarkNumber()+","+avgTemp;
    }
}