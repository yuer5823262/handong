...
@RequestMapping("api/FaceTempSensorInfo")
@Controller
@Api(description = "表面温度信息")
public class FaceTempSensorInfoController {
    @Autowired
    FaceTempSensorInfoService FaceTempSensorInfoService;
    @Autowired
    ...
    @GetMapping("/list")
    @ResponseBody
    public ApiRestResponse listFaceTempSensorInfo(@RequestParam Integer pageNum,
                                                   @RequestParam Integer pageSize) {
        PageInfo pageInfo = FaceTempSensorInfoService.orUserList(pageNum, pageSize);
        return ApiRestResponse.success(pageInfo);
    }
    @PostMapping("/add")
    @ResponseBody
    public ApiRestResponse addFaceTempSensorInfo(@RequestBody InnerTempSensorInfoAdd FaceTempSensorInfoAdd) {
        FaceTempSensorInfoService.add(FaceTempSensorInfoAdd);
    ...
    public ApiRestResponse addByRemoteDev(@RequestBody RemoteDev remoteDev) {
        FaceTempSensorInfoService.addByRemoteDev(remoteDev);
        return ApiRestResponse.success();
    }

    @PostMapping("/select")
    @ResponseBody
    public ApiRestResponse listSelectFaceTempSensorInfo(@RequestBody InnerTempSensorInfoQue FaceTempSensorInfoQue) {
        PageInfo pageInfo = FaceTempSensorInfoService.orUserSelect(FaceTempSensorInfoQue);
        return ApiRestResponse.success(pageInfo);
    }
    ...
    public ApiRestResponse listSelectDamTemp(@RequestBody DamTempQue damTempQue) {
        List<DamTempVO> damTempVOList = FaceTempSensorInfoService.damTemp(damTempQue);
    ...
    public ApiRestResponse tempMonitor() {
        List<InnerTempMonitorVO> innerTempMonitorVOList = FaceTempSensorInfoService.tempMonitor();
    ...
    @ResponseBody
    public ApiRestResponse listCoolingRate(@RequestBody InnerTempSensorInfoQue FaceTempSensorInfoQue) {
        PageInfo pageInfo = FaceTempSensorInfoService.CoolingRate(FaceTempSensorInfoQue);
        return ApiRestResponse.success(pageInfo);
    }
    ...
    public ApiRestResponse listMaxTemp(@RequestBody TopTempAssessQue topTempAssessQue) {
        PageInfo pageInfo = FaceTempSensorInfoService.maxTemp(topTempAssessQue);
        return ApiRestResponse.success(pageInfo);
    }
    ...
    public void coolingRateExportMemberListByQue(ModelMap map,
                                                 ...
                                                 @RequestBody InnerTempSensorInfoQue FaceTempSensorInfoQue) {

        List<CoolingRateVo> memberList = FaceTempSensorInfoService.CoolingRateExportList(FaceTempSensorInfoQue);
    ...
    public void exportMemberList(ModelMap map,
                                 HttpServletRequest request,
                                 HttpServletResponse response) {
        List<InnerTempSensorInfoVO> memberList = FaceTempSensorInfoService.exportList();
        ExportParams params = new ExportParams("表面温度信息", "表面温度信息", ExcelType.XSSF);
        map.put(NormalExcelConstants.DATA_LIST, memberList);
    ...
    public void exportMemberListByQue(ModelMap map,
                                      ...
                                      HttpServletResponse response,
                                      @RequestBody InnerTempSensorInfoQue FaceTempSensorInfoQue) {
        List<InnerTempSensorInfoVO> memberList = FaceTempSensorInfoService.exportListByque(FaceTempSensorInfoQue);
...
//            List<FaceTempSensorInfo> FaceTempSensorInfoList = new ArrayList<>();
//            for (InnerTempSensorInfoEx FaceTempSensorInfoEx:list)
//            {
//                FaceTempSensorInfo FaceTempSensorInfo = new FaceTempSensorInfo();
//                InnerTempSensor innerTempSensor = innerTempSensorMapper.selectByTempNo(FaceTempSensorInfoEx.getTempSensorNo());
//                FaceTempSensorInfo.setInnerTempSensorId(innerTempSensor.getId());
//                FaceTempSensorInfo.setTemp(InnerTempSensorInfoEx.getTemp());
//                FaceTempSensorInfo.setTime(InnerTempSensorInfoEx.getTime());
//                FaceTempSensorInfo.setAvgtemp(InnerTempSensorInfoEx.getTemp());
//                FaceTempSensorInfo.setBl((byte) 1);
//                MaxTempNormVO maxTempNormVO = MaxTempAlertMapper.normInfo(FaceTempSensorInfo.getInnerTempSensorId());
//                FaceTempSensorInfo.setNorm(maxTempNormVO.getMaxTemp());
//                FaceTempSensorInfoList.add(FaceTempSensorInfo);
//            }
//            FaceTempSensorInfoService.addAll(FaceTempSensorInfoList);
